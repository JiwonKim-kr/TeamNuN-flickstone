...
def section_demo_ci_profile() -> None:
    ...
    check("demo 대표 회귀 12종 고정", len(configured) == 12)
    check("demo P5-DZ 회귀 포함", "run_p5_turn_start_damage_zones.py" in configured)
    check("demo P5-FP 회귀 포함", "run_p5_first_play_five_minute_flow.py" in configured)
