...
const EXPECTED_FINGERPRINT: String = "16df0d24ed90733b2f5f8b3761fd37830154e550c74fc00adba3a9445fa07167"
...
func test_catalog(catalog: ContentCatalog) -> void:
	...
	check("P4-2-CATALOG-V8-COUNTS", status.is_ok() and catalog.catalog_schema_version() == 8 and catalog.registry_entry_count() == 20 and catalog.act_count() == 1 and catalog.encounter_count() == 4 and catalog.enemy_count() == 5 and catalog.relic_count() == 0 and catalog.consumable_count() == 0)
