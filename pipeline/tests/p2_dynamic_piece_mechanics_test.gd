...
const EXPECTED_FINGERPRINT: String = "6fe861d4d8eeac383d741b7644a662fcdd9b3b61d62aaecaa89591f0f72188e4"
...
func _init() -> void:
	...
	check("P2-4-SCHEMA-CATALOG-V11", loaded and content_status.is_ok() and catalog.piece_count() == 6 and catalog.ability_count() == 12 and catalog.fingerprint_hex() == EXPECTED_FINGERPRINT)
