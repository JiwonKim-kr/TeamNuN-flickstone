...
const EXPECTED_HEX: String = ""
const EXPECTED_SHA256: String = "1cd25f0fb2f5202a57e10f959c6cfa90c57ada377013edc7dd9206251b981e80"
...
func fixture_state(catalog: ContentCatalog, order: Array[int], status: SimStatus) -> RunState:
	return RunState.create(catalog, 1, 17, 29, fixture_initial(order, status), status)
...
func test_snapshot_rejections(catalog: ContentCatalog, bytes: PackedByteArray) -> void:
	...
	var duplicate_roster_id: PackedByteArray = bytes.duplicate(); write_u32(duplicate_roster_id, 253, 1)
...
func _init() -> void:
	...
	check("P4-1-RUNTIME-CATALOG-LOAD", loaded and content_status.is_ok() and catalog.fingerprint_hex() == "8067a487ceb0ef2d721a3a985d8c5b7c0d8185cd4f52ce30c9d8cb59fd68edca")
