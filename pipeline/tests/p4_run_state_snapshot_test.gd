...
const EXPECTED_HEX: String = ""
const EXPECTED_SHA256: String = "ebd81a0efc40ca9476bb5ac09a7bb56333d15bda862b936177fba75772c12b43"
...
func _init() -> void:
	...
	check("P4-1-RUNTIME-CATALOG-LOAD", loaded and content_status.is_ok() and catalog.fingerprint_hex() == "aa7758ad0ccbb5ef73fe66f162b004243b3410a536c559e7ff584139267e7ee1")
