...
func _init() -> void:
	...
	check("P2-3-SCHEMA-CATALOG-V8", loaded and content_status.is_ok() and catalog.status_count() == 3 and catalog.synergy_count() == 1 and catalog.fingerprint_hex() == "b9562bc7c462c4094b0756e92b8c01fe3f560ac320ba6c2acd685acc35431ee3")
