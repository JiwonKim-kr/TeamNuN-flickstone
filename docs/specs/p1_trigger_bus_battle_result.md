...
| 구현 권한 | 승인 범위 내 구현 가능. 현재 요청은 T-01에 한정 |
| 구현 상태 | T-01 구현 완료 · 정적/`--skip-godot` 전체 검증 통과 · Godot narrow 대기 · T-02~10 미구현 |
...
T-01~10 권장안은 2026-08-22 사용자 전체 승인으로 구현 기준이 됐다. 현재 구현 요청은 T-01에 한정하며, 후속 항목은 별도 요청 전까지 구현하지 않는다.
