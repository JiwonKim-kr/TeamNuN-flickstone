...
- P1-1 CTB/BattleState is approved, implemented, and verified. P1-2 launch/aim/prediction is approved, implemented, and narrow-verified; resume with `verify --full` before starting P1-3.
