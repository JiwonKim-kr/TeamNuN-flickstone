...
- P2-6 runtime content and the playable data-driven graybox are approved, implemented, automated-verified, and human-reviewed. Runtime contains two roster pieces, one graybox-only piece, one ability/status, two synergies, one neutral map, and five enemies after the P4 development ELITE/BOSS append. Its P2 baseline fingerprint was `f721ffce47ff27324a92dd8c9564e75463113fd5adb10ee7ebb388889511cf0e`; P3 migrated it to catalog v6, P4-2 to v7, P4-4 to v8, P4-5 to v9, and the P4/P5 integration now owns catalog/fingerprint v10.
...
- P5-DZ encounter-owned turn-start damage zones are approved and implemented. Runtime maps are neutral and each development encounter owns one central 15-damage zone. Circle/polygon tangency counts, overlapping zones resolve by ascending zone ID before surviving `ON_TURN_START`, and environmental deaths do not create `ON_KILL` or kill tally credit. The P4/P5 integration uses abilities v6, encounters v2, catalog/fingerprint v10, BattleSnapshot v9, and RunSnapshot v2. The current runtime fingerprint is `68a8bc7f39ba0bc8d80c4ab097e09fc6c901ecdf7f020f8d3c5f2112f9d0e078`; the 335-byte RunSnapshot v2 cross-KAT hashes to `f7d9ad1ed82658bf30cabe2d0eeb5227597f359b74afa814a0a4c2c113f346e2`. Human play review and formal-release exhaustive verification remain follow-ups.
...
- Eight A-direction token reference concepts under `assets/art/concepts/p5_token_refs_a/` pass 512x512 PNG probes. The selected board plus `baduk_stone_refined_00.png`, bottle cap, caveman, AI core, bouncy ball, chess knight, and fire elemental are human-approved as the exact eight-image `art lock` training set. Training and test-sample preparation are authorized; manifest style lock, 64x64 runtime generation, and gameplay reskin remain prohibited until the post-training human approval.
