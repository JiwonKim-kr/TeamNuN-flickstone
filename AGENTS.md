...
- P5-DZ encounter-owned turn-start damage zones are approved, implemented, and demo-verified. Runtime maps are neutral and each development encounter owns one central 15-damage zone. Circle/polygon tangency counts, overlapping zones resolve by ascending zone ID before surviving `ON_TURN_START`, and environmental deaths do not create `ON_KILL` or kill tally credit. Abilities v6, encounters v2, catalog/fingerprint v8, and BattleSnapshot v9 are current; the runtime fingerprint is `16df0d24ed90733b2f5f8b3761fd37830154e550c74fc00adba3a9445fa07167`, and the unchanged 331-byte RunSnapshot v1 now hashes to `8c8671cd39afe6defc986644d56122315cd6191d03793416620d2fbf95f87c04`. The dedicated 9-group narrow, P2-6 quick 22-group regression, and Godot 4.6.3 `verify --demo` pass; human play review and the formal-release 16x2 exact terminal refresh remain follow-ups.
