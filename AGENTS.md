...
- P2-3 status lifetime, synergy tally, modifier aggregation, three reserved effects, physical materialization boundary, and BattleSnapshot v5 are approved for implementation. Runtime status/synergy records remain empty until later content approval.
