...
enum Operation {
	...
	REWARD_PROFILE_VALIDATE = 16,
	RELIC_VALIDATE = 17,
	CONSUMABLE_VALIDATE = 18,
	SHOP_VALIDATE = 19,
	EVENT_VALIDATE = 20,
	RUN_EFFECT_VALIDATE = 21,
}
...
enum FieldId {
	...
	VICTORY_GOLD = 103,
	RECRUIT_CHOICE_COUNT = 104,
	RECRUIT_POOL_REFS = 105,
	REVENGE_STATUS_REF = 106,
	MAX_STACK_COUNT = 107,
	USE_PHASE_ID = 108,
	EFFECT = 109,
	PRIMARY_NUMERIC_ID = 110,
	AMOUNT = 111,
	OFFERS = 112,
	OFFER_ID = 113,
	ITEM_KIND_ID = 114,
	...
	ELASTICITY_MULTIPLIER_RAW = 121,
	CLEAN_HIT_DAMAGE_MULTIPLIER_RAW = 122,
}
